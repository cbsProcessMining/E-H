...
SELECT DISTINCT
	...
	,CASE
		...
		WHEN CDPOS.FNAME = 'LOEKZ' AND CDPOS.VALUE_OLD ='S' AND CDPOS.VALUE_NEW IS NULL THEN 'Reaktiviere Bestellposition'
		WHEN CDPOS.FNAME = 'LOEKZ' AND CDPOS.VALUE_NEW ='L' THEN 'Lösche Bestellposition'
		WHEN CDPOS.FNAME = 'LOEKZ' AND CDPOS.VALUE_OLD ='L' AND CDPOS.VALUE_NEW IS NULL THEN 'Reaktiviere Bestellposition'
		...
		WHEN CDPOS.FNAME = 'LABNR' AND CDPOS.VALUE_OLD IS NULL THEN 'Erhalte Auftragsbestätigung'
	...
	,CASE 
		...
		WHEN CDPOS.FNAME = 'LOEKZ' AND CDPOS.VALUE_OLD ='S' AND CDPOS.VALUE_NEW IS NULL THEN 'Reactivate Purchase Order Item'
		WHEN CDPOS.FNAME = 'LOEKZ' AND CDPOS.VALUE_NEW ='L' THEN 'Delete Purchase Order Item'
		WHEN CDPOS.FNAME = 'LOEKZ' AND CDPOS.VALUE_OLD ='L' AND CDPOS.VALUE_NEW IS NULL THEN 'Reactivate Purchase Order Item'
		...
		WHEN CDPOS.FNAME = 'LABNR' AND CDPOS.VALUE_OLD IS NULL THEN 'Receive Order Confirmation'
	...
	,CASE 
		...
		WHEN CDPOS.FNAME = 'LOEKZ' AND CDPOS.VALUE_OLD ='S' AND CDPOS.VALUE_NEW IS NULL THEN 620
		WHEN CDPOS.FNAME = 'LOEKZ' AND CDPOS.VALUE_NEW ='L' THEN 630
		WHEN CDPOS.FNAME = 'LOEKZ' AND CDPOS.VALUE_OLD ='L' AND CDPOS.VALUE_NEW IS NULL THEN 640
...
FROM
	...
	INNER JOIN TMP_P2P_EKKO_EKPO AS E ON 1=1
		...
		AND CDPOS.TABKEY = E.MANDT ||E.EBELN || E.EBELP -- global job Anpassung da hier über E._CASE_KEY gegangen wurde
	...
	LEFT JOIN (
		SELECT TCURX."SCHEMA", -- global job 
			TCURX.CURRKEY
