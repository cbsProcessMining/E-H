...
SELECT DISTINCT 
	...
	,E.EBELP AS "EBELP"
    ,CASE
        WHEN CDPOS.VALUE_NEW IS NULL THEN 'Entferne Zahlsperre'
        WHEN CDPOS.VALUE_OLD IS NULL THEN 'Setze Zahlsperre'
    END AS "ACTIVITY_DE"
    ,CASE
    ...
    ,CASE
        WHEN CDPOS.VALUE_NEW IS NULL THEN 2410
        WHEN CDPOS.VALUE_OLD IS NULL THEN 2420
    END AS _SORTING
...
FROM 
    ...
    LEFT JOIN USR02 AS USR02 ON 1=1
        AND CDHDR."SCHEMA" = USR02."SCHEMA" -- global job
