...
FROM 
	...
	LEFT JOIN DD07T AS DD07T ON 1=1
        AND EKKO."SCHEMA" = DD07T."SCHEMA" -- global job
	...
	LEFT JOIN DD07T AS DD07T_EKKO_STATU ON 1=1
        AND EKKO."SCHEMA" = DD07T_EKKO_STATU."SCHEMA" -- global job
	...
	LEFT JOIN T161T AS T161T ON 1=1
        AND EKKO."SCHEMA" = T161T."SCHEMA" -- global job
