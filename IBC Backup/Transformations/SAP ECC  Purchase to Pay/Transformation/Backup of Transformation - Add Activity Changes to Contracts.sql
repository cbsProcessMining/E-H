...
SELECT DISTINCT
  ...
  --  ,E.KTPNR AS "KTPNR"
    ...
    ,"E"."PRETTY_NAME"||CDHDR."MANDANT" || CDHDR."OBJECTCLAS" || CDHDR."OBJECTID" || CDHDR."CHANGENR" AS "_ACTIVITY_KEY"
FROM
	CDPOS AS CDPOS
	INNER JOIN EKPO AS CONTRACTS ON 1=1
        AND CDPOS."SCHEMA" = CONTRACTS."SCHEMA" -- global job
    ...
    INNER JOIN TMP_P2P_EKKO_EKPO AS E ON 1=1
    	AND E."SCHEMA" = CONTRACTS."SCHEMA" -- global job
	...
	LEFT JOIN TCURF_CC AS TCURF_CC ON 1=1
		...
		AND CONTRACTS.AEDAT >= TCURF_CC.VALID_START	
		AND CONTRACTS.AEDAT < TCURF_CC.VALID_END
	LEFT JOIN T001 AS T001 ON 1=1
        AND CONTRACTS."SCHEMA" = T001."SCHEMA" -- global job
