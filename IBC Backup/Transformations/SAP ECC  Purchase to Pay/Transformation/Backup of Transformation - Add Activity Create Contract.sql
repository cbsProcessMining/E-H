...
SELECT DISTINCT 
    ...
    , "E"."PRETTY_NAME"||EKKO_CONTRACT.MANDT || EKKO_CONTRACT.EBELN AS "_ACTIVITY_KEY" -- global job
FROM TMP_P2P_EKKO_EKPO AS E
INNER JOIN EKPO AS EKPO_CONTRACT ON 1=1
    AND E."SCHEMA" = EKPO_CONTRACT."SCHEMA" -- global job
...
INNER JOIN EKKO AS EKKO_CONTRACT ON 1=1
	AND EKPO_CONTRACT."SCHEMA" = EKKO_CONTRACT."SCHEMA" -- global job
...
LEFT JOIN CDPOS AS CDPOS_HEAD ON 1=1
    AND CDPOS_HEAD."SCHEMA" = EKKO_CONTRACT."SCHEMA" -- global job
