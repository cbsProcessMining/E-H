...
SELECT DISTINCT
	...
	,A.AUFNR
	,A.POSNR
	,'Geplantes Fertigungsende' AS ACTIVITY_DE
	,'Scheduled finish time' AS ACTIVITY_EN
	,CAST(A.GLTRS AS DATE) + CAST(A.GLUZS AS TIME) AS EVENTTIME
	,40000 AS "_SORTING"
...
WHERE 1=1
    AND A.GLTRS IS NOT NULL 
    AND A.GLUZS IS NOT NULL;